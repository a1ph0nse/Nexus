# coding=utf-8
# Adapted from
# https://github.com/huggingface/transformers/blob/v4.28.0/src/transformers/models/ProGen/modeling_ProGen.py
...
"""Inference-only ProGen model compatible with HuggingFace weights.
...
# from sarathi.model_executor.models import ProGenConfig
...
class ProGenDecoderLayer(nn.Module):
    ...
    def __init__(
        ...
        self.self_attn = ProGenAttention(
        ...
        self.ln_l = nn.LayerNorm(config.n_embd, eps=config.layer_norm_epsilon)
...
class ProGenModel(nn.Module):
    ...
    def __init__(
        ...
        self.layers = nn.ModuleList(
            [
                ProGenDecoderLayer(config, layer_id=layer_id + layer_offset)
