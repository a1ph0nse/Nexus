...
def _get_and_verify_max_len(
    ...
    # Only apply scaling if rope_scaling exists and contains a factor
    if rope_scaling is not None:
        ...
        # Some newer HF configs may store rope_scaling as non-dict or without factor
        if isinstance(rope_scaling, dict) and "factor" in rope_scaling:
            ...
            # New HF configs may have rope_theta but no scaling factor
