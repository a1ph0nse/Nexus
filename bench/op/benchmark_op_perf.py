...
def bench_attn(seqlen_configs, models):
    for model in models:
        for seqlen_config in seqlen_configs:
            ...
            filename = f'./{dir_path}/op_perf_v4.csv'
...
if __name__ == "__main__":
    ...
    for i in range(2):
        seqlen_configs.append([(1024 * 8, 1)] * 13 + [(1024 * 1, 1)] * 41 + [(512 * (i + 1), 512)] * 1)
    for i in range(2):
        seqlen_configs.append([(1024 * 4, 1)] * 27 + [(1024 * 1, 1)] * 27 + [(512 * (i + 1), 512)] * 1)
    for i in range(2):
        seqlen_configs.append([(1024 * 2, 1)] * 41 + [(1024 * 1, 1)] * 13 + [(512 * (i + 1), 512)] * 1)
    ...
    for i in range(2):
        seqlen_configs.append([(1024 * 8, 1)] * 13 + [(1024 * 1, 1)] * 41 + [(2048 * (i + 1), 2048)] * 1)
    for i in range(2):
        seqlen_configs.append([(1024 * 4, 1)] * 27 + [(1024 * 1, 1)] * 27 + [(2048 * (i + 1), 2048)] * 1)
    for i in range(2):
        seqlen_configs.append([(1024 * 2, 1)] * 41 + [(1024 * 1, 1)] * 13 + [(2048 * (i + 1), 2048)] * 1)
