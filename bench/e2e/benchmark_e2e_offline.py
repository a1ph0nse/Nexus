...
models = utils.models
# models = ['llama-2-7b-1', 'llama-3-8b-1', 'yi-6b-1'] # yi-6b要小至少一半，不然太慢了, Llama也要少点
# models = ['llama-3-8b-1', 'yi-6b-1']
# models = ['llama-2-7b-1']
# models = ['yi-6b-1']
# models = ['progen2-1', 'llama-13b-1']
# models = ['progen2-1']
models = ['llama-13b-1']
attention_backends = [
    # 'fa_paged_256',
...
if utils.args.test == True:
    models, attention_backends = {'yi-6b-1'}, ['fa_paged_256']
    num_requests = 8
    ...
    for backend in attention_backends:
        ...
        command = [
            'python', main,
                ...
                '--output_dir', f'{experiment_dir}_a100/model_{model}_attn_{backend}_pdr_{pd_ratio}_rqs_{num_requests}_cl_{max_tokens}_sarathi',
